...
gcc -m32 -ffreestanding -fno-stack-protector -g -c net.c -o net.o
ld -m elf_i386 -T link.ld -o $OUT_DIR/kernel.bin start.o kernel.o paging.o pmm.o swap.o fs.o net.o
